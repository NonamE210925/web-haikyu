...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Video</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("video/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <div class="dropzone required" input="#ctrl-video" fieldname="video"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="200" maximum="1">
                                                    <input name="video" id="ctrl-video" required="" class="dropzone-input form-control" value="<?php  echo $data['video']; ?>" type="text"  />
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-episod"  value="<?php  echo $data['episod']; ?>" type="text" placeholder="Enter Episod"  required="" name="episod"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
