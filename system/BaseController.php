...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['tumbler'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['audio'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
			"returnfullpath" => true,
			"filenameprefix" => "",
			"uploadDir" => "uploads/files/audio/"
		);
	

		$this->file_upload_settings['video'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "200",
